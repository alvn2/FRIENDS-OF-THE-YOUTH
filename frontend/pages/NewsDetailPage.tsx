  ...
  if (!article) {
    return (
      <div className="container mx-auto px-4 py-16 text-center">
        ...
        <ReactRouterDOM.Link to="/news" className="text-brand-red hover:underline mt-6 inline-block">
    ...
    <div className="bg-white dark:bg-dark-bg py-8 md:py-16">
      <div className="container mx-auto px-4 max-w-4xl">
        <article className="prose dark:prose-invert max-w-none">
          <div className="mb-6">
            <ReactRouterDOM.Link to="/news" className="text-brand-red hover:underline text-sm">
              &larr; Back to all news
            </ReactRouterDOM.Link>
          </div>
          <span className="text-sm font-semibold text-brand-red uppercase">{article.category}</span>
