...
const DonationsIcon = () => <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c-1.11 0 2.08.402 2.599 1M12 8V7m0 1v.01" /></svg>;
  ...
  if (!user || user.role !== 'admin') {
    return (
      <div className="container mx-auto px-4 py-16 text-center">
        ...
        <Link to="/" className="text-brand-primary hover:underline mt-6 inline-block">Go to Homepage</Link>
      </div>
    );
  }
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <div className="bg-white dark:bg-dark-card p-6 rounded-lg shadow-md">
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <input
                  ...
                  className="flex-grow shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-brand-primary focus:border-brand-primary block w-full p-2.5 dark:bg-gray-700"
                  disabled={isLoading}
                />
                <button onClick={handleGeneratePost} disabled={isLoading} className="text-white bg-brand-primary hover:bg-brand-primary-dark font-medium rounded-lg text-sm px-5 py-2.5 disabled:bg-gray-400">
            ...
            <div className="bg-white dark:bg-dark-card p-6 rounded-lg shadow-md">
                <div className="flex justify-between items-center mb-4">
                    ...
                    <Link to="/admin/volunteers" className="text-sm font-medium text-brand-primary hover:underline">View All</Link>
                </div>
